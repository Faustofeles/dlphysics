    ...
    for e in range(epochs):
        ...
        test_acc.append(accuracy_score(y_test.argmax(1), 
						sess.run(logits, feed_dict={
							X:X_test, dropout: 1}).argmax(1)))
        
        test_loss.append(sess.run(loss_op, 
        				feed_dict={X: X_test, 
        						   Y: y_test,
        						   dropout:1}))
